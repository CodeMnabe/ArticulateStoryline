/*! xAPIWrapper v 1.11.0 | Built on 2020-01-16 07:49:05-0500 */
...
var CryptoJS =
  (CryptoJS =
    ...
    (function (l) {
      ...
      var u = (e.WordArray = i.extend({
          ...
          ((r.Base64 = {
            ...
            parse: function (t) {
              ...
              for (var o = [], s = 0, a = 0; a < e; a++)
                if (a % 4) {
                  var c = i.indexOf(t.charAt(a - 1)) << ((a % 4) * 2),
                    p = i.indexOf(t.charAt(a)) >>> (6 - (a % 4) * 2);
                  (o[s >>> 2] |= (c | p) << (24 - (s % 4) * 8)), s++;
                }
              return u.create(o, s);
            },
            ...
            _process: function (t) {
              var e = this._data,
                ...
                s =
                  (o = t
                    ? l.ceil(o)
                    : l.max((0 | o) - this._minBufferSize, 0)) * r,
                a = l.min(4 * s, n);
              if (s) {
        ...
        f = (d.SHA1 = p.extend({
          ...
          _doProcessBlock: function (t, e) {
            for (
              ...
              if (c < 16) h[c] = 0 | t[e + c];
                ...
                var p = h[c - 3] ^ h[c - 8] ^ h[c - 14] ^ h[c - 16];
                h[c] = (p << 1) | (p >>> 31);
              }
              var l = ((n << 5) | (n >>> 27)) + a + h[c];
              (l +=
                c < 20
                  ? 1518500249 + ((r & o) | (~r & s))
                  : c < 40
          ...
          _doFinalize: function () {
            ...
            return (
              (e[n >>> 5] |= 128 << (24 - (n % 32))),
              (e[14 + (((64 + n) >>> 9) << 4)] = l.floor(i / 4294967296)),
              (e[15 + (((64 + n) >>> 9) << 4)] = i),
      ...
      return (
        (t.SHA1 = p._createHelper(f)), (t.HmacSHA1 = p._createHmacHelper(f)), t
      );
    })(Math)) ||
  (function (a) {
    function i() {}
    var t = {},
      ...
      s = (r.Latin1 = {
        stringify: function (t) {
          ...
          for (var i = [], n = 0; n < t; n++)
            i.push(
              String.fromCharCode((e[n >>> 2] >>> (24 - (n % 4) * 8)) & 255)
            );
          return i.join("");
        },
        parse: function (t) {
...
function toBase64(t) {
  return CryptoJS && CryptoJS.enc.Base64
    ? CryptoJS.enc.Base64.stringify(CryptoJS.enc.Latin1.parse(t))
    : Base64.encode(t);
}
function toSHA1(t) {
  return CryptoJS && CryptoJS.SHA1
    ? CryptoJS.SHA1(t).toString()
    : Crypto.util.bytesToHex(Crypto.SHA1(t, { asBytes: !0 }));
}
function toSHA256(t) {
  if ("[object ArrayBuffer]" !== Object.prototype.toString.call(t))
    return CryptoJS.SHA256(t).toString(CryptoJS.enc.Hex);
  for (var e = new Uint8Array(t), i = [], n = 0; n < e.length; n += 4)
    i.push((e[n] << 24) | (e[n + 1] << 16) | (e[n + 2] << 8) | e[n + 3]);
  return CryptoJS.SHA256(CryptoJS.lib.WordArray.create(i, e.length)).toString(
    CryptoJS.enc.Hex
  );
}
function isDate(t) {
  if ("[object Date]" === Object.prototype.toString.call(t)) var e = t;
  else e = new Date(t);
  return "[object Date]" === Object.prototype.toString.call(e)
    ? isNaN(e.valueOf())
      ? (ADL.XAPIWrapper.log("Invalid date String passed"), null)
      : e
...
!(function (r) {
  ...
  for (
    ...
    p && (c < 8 && (s[c] = t(r.pow(a, 0.5))), (f[c] = t(r.pow(a, 1 / 3))), c++),
      a++;
  }
  var g = [];
  o = o.SHA256 = n.extend({
    ...
    _doFinalize: function () {
      ...
      return (
        (e[n >>> 5] |= 128 << (24 - (n % 32))),
        (e[14 + (((64 + n) >>> 9) << 4)] = r.floor(i / 4294967296)),
        (e[15 + (((64 + n) >>> 9) << 4)] = i),
        (t.sigBytes = 4 * e.length),
        this._process(),
        this._hash
  ...
  (function (t) {
    if (void 0 === t.TextEncoder) {
      ...
      (e.prototype.encode = function (t) {
        for (
          var e = new Uint8Array(3 * t.length), i = -1, n = t.length, r = 0;
          r < n;
          ...
          for (
            o <= 127
              ...
              : o <= 65535
              ? ((s = 12), (a = 224))
              : o <= 2097151 && ((s = 18), (a = 240)),
              e[(i += 1)] = a | (o >> s),
              s -= 6;
            0 <= s;

          )
            (e[(i += 1)] = 128 | ((o >> s) & 63)), (s -= 6);
          r += 65536 <= o ? 2 : 1;
        }
        ...
        for (var e = [], i = "", n = 0, r = arguments.length; n !== r; ++n) {
          ...
          16383 <=
            (o <= 65535
              ? e.push(o)
              : ((o -= 65536),
                e.push(55296 + (o >> 10), (o % 1024) + 56320))) &&
      ...
      (i.prototype.decode = function (t) {
        for (var e = "", i = 0; i < t.length; ) {
          ...
          if (
            ...
            for (var s = 0; s < r; )
              (o = (o << 6) | (63 & (n = t[i + s + 1]))), (s += 1);
          else (o = 65533), (r = t.length - i);
          (e += a(o)), (i += r + 1);
        }
        return e;
      }),
  ...
  ((window.ADL = window.ADL || {}).activityTypes = {
  ...
  (function (_) {
    ...
    function t(t, e) {
      ...
      (this.lrs = (function (t) {
        ...
        if (
          void 0 !==
            (e = (function () {
              var t, e, i, n, r;
              for (
                t = window.location.search.substr(1),
                  e = t.split("&"),
                  r = {},
                  n = 0;
                n < e.length;
        ...
        this.lrs.user &&
          this.lrs.password &&
          n(this.lrs, this.lrs.user, this.lrs.password),
        (this.base = i(this.lrs.endpoint)),
        (this.withCredentials = !1),
        t &&
          void 0 !== t.withCredentials &&
          (this.withCredentials = t.withCredentials),
        (this.strictCallbacks = !1),
        (this.strictCallbacks = t && t.strictCallbacks),
        e &&
          r.call(this) &&
              ...
              if (200 == t.status)
                try {
                  var e = JSON.parse(t.response),
                    i = !1;
                  for (var n in e.version)
                    if (
                      e.version.hasOwnProperty(n) &&
                      e.version[n] == _.XAPIWrapper.xapiVersion
                    ) {
                      i = !0;
                      break;
                    }
                ...
                _.XAPIWrapper.log(
                  "The request to get information about the LRS failed: " + t
                );
            },
            null,
            !1,
        ...
        (this.changeConfig = function (t) {
          try {
            _.XAPIWrapper.log("updating lrs object with new configuration"),
              (this.lrs = a(this.lrs, t)),
              t.user &&
                t.password &&
                this.updateAuth(this.lrs, t.user, t.password),
              (this.base = i(this.lrs.endpoint)),
              (this.withCredentials = t.withCredentials),
              (this.strictCallbacks = t.strictCallbacks);
          } catch (t) {
    ...
    var e,
      i =
        (((e = { endpoint: "http://localhost:8000/xapi/" }).auth =
          "Basic " + toBase64("tom:1234")),
        e);
    function r() {
      try {
    ...
    function a(e, i) {
      for (var n in i)
        if (0 != i.hasOwnProperty(n)) {
          u(n + " : " + i[n]);
          try {
            i[n].constructor == Object
              ? (e[n] = a(e[n], i[n]))
    ...
    (t.prototype.xapiVersion = "1.0.1"),
      (t.prototype.prepareStatement = function (t) {
        void 0 === t.actor
          ? (t.actor = JSON.parse(this.lrs.actor))
          : "string" == typeof t.actor && (t.actor = JSON.parse(t.actor)),
          (this.lrs.grouping ||
            this.lrs.registration ||
            this.lrs.activity_platform) &&
            (t.context || (t.context = {})),
          this.lrs.grouping &&
            (t.context.contextActivities || (t.context.contextActivities = {}),
            Array.isArray(t.context.contextActivities.grouping)
              ? t.context.contextActivities.grouping.splice(0, 0, {
                  id: this.lrs.grouping,
                })
              : (t.context.contextActivities.grouping = [
                  { id: this.lrs.grouping },
                ])),
          this.lrs.registration &&
            (t.context.registration = this.lrs.registration),
          this.lrs.activity_platform &&
            (t.context.platform = this.lrs.activity_platform);
      }),
      (t.prototype.testConfig = r),
      (t.prototype.log = u),
      (t.prototype.defaultEncoding = "utf-8"),
      (t.prototype.sendStatement = function (t, e, i) {
        if (this.testConfig()) {
          var n;
          this.prepareStatement(t),
            t.id ? (n = t.id) : ((n = _.ruuid()), (t.id = n));
          var r = JSON.stringify(t),
            o = null;
          i &&
            0 < i.length &&
            ((o = {}), (r = this.buildMultipartPost(t, i, o)));
          var s = _.XHR_request(
            this.lrs,
      ...
      (t.prototype.stringToArrayBuffer = function (t, e) {
        return (
          (e = e || _.XAPIWrapper.defaultEncoding),
          new TextEncoder(e).encode(t).buffer
        );
      }),
      (t.prototype.stringFromArrayBuffer = function (t, e) {
        return (
          (e = e || _.XAPIWrapper.defaultEncoding), new TextDecoder(e).decode(t)
        );
      }),
      (t.prototype.buildMultipartPost = function (t, e, i) {
        ...
        for (var n = 0; n < e.length; n++)
          "signature" == e[n].type &&
            ...
            "string" == typeof e[n].value &&
              (e[n].value = this.stringToArrayBuffer(e[n].value)),
            (e[n].type.length = e[n].value.byteLength),
            (e[n].type.sha2 = toSHA256(e[n].value)),
            t.attachments.push(e[n].type);
        var r = [],
          o =
        ...
        for (var n in (r.push(a), e))
          if (e.hasOwnProperty(n)) {
            var c =
              [
                "--" + o,
                "Content-Type: " + e[n].type.contentType,
                "Content-Transfer-Encoding: binary",
                "X-Experience-API-Hash: " + e[n].type.sha2,
              ].join(s) +
              s +
              s;
            r.push(c), r.push(e[n].value);
          }
      ...
      (t.prototype.sendState = function (t, e, i, n, r, o, s, a) {
        if (this.testConfig()) {
          ...
          )).replace("<agent>", encodeURIComponent(JSON.stringify(e)))).replace(
            "<stateid>",
            encodeURIComponent(i)
          )),
            n && (c += "&registration=" + encodeURIComponent(n));
          var p = null;
          o && s
            ? u("Can't have both If-Match and If-None-Match")
            : o
            ? (p = { "If-Match": _.formatHash(o) })
            : s && (p = { "If-None-Match": _.formatHash(s) });
          var l = "PUT";
          ...
          r instanceof Array
            ...
            ? ((r = JSON.stringify(r)),
              ((p = p || {})["Content-Type"] = "application/json"),
              (l = "POST"))
            : ((p = p || {})["Content-Type"] = "application/octet-stream"),
            _.XHR_request(
              this.lrs,
              c,
              l,
      ...
      (t.prototype.getState = function (t, e, i, n, r, o) {
        if (this.testConfig()) {
          ...
          (s = (s = s.replace("<activity ID>", encodeURIComponent(t))).replace(
            "<agent>",
            encodeURIComponent(JSON.stringify(e))
          )),
            i && (s += "&stateId=" + encodeURIComponent(i)),
            n && (s += "&registration=" + encodeURIComponent(n)),
            r &&
              null != (r = isDate(r)) &&
      ...
      (t.prototype.deleteState = function (t, e, i, n, r, o, s) {
        if (this.testConfig()) {
          ...
          (a = (a = (a = a.replace(
            ...
            n && (a += "&registration=" + encodeURIComponent(n));
          var c = null;
          r && o
            ? u("Can't have both If-Match and If-None-Match")
            : r
            ? (c = { "If-Match": _.formatHash(r) })
            : o && (c = { "If-None-Match": _.formatHash(o) });
          var p = _.XHR_request(
            this.lrs,
            a,
            "DELETE",
          ...
          if (void 0 === p || 404 == p.status) return null;
          try {
      ...
      (t.prototype.sendActivityProfile = function (t, e, i, n, r, o) {
        if (this.testConfig()) {
          ...
          n && r
            ? u("Can't have both If-Match and If-None-Match")
            : n
            ? (a = { "If-Match": _.formatHash(n) })
            : r && (a = { "If-None-Match": _.formatHash(r) });
          var c = "PUT";
      ...
      (t.prototype.getActivityProfile = function (t, e, i, n) {
        if (this.testConfig()) {
          ...
          (r = r.replace("<activity ID>", encodeURIComponent(t))),
            e && (r += "&profileId=" + encodeURIComponent(e)),
            i &&
              null != (i = isDate(i)) &&
              (r += "&since=" + encodeURIComponent(i.toISOString()));
          var o = _.XHR_request(
            this.lrs,
            r,
            "GET",
      ...
      (t.prototype.deleteActivityProfile = function (t, e, i, n, r) {
        if (this.testConfig()) {
          var o =
            this.lrs.endpoint +
            "activities/profile?activityId=<activity ID>&profileId=<profileid>";
          o = (o = o.replace("<activity ID>", encodeURIComponent(t))).replace(
            "<profileid>",
            encodeURIComponent(e)
          );
          var s = null;
          i && n
            ? u("Can't have both If-Match and If-None-Match")
            : i
            ? (s = { "If-Match": _.formatHash(i) })
            : n && (s = { "If-None-Match": _.formatHash(n) });
          var a = _.XHR_request(
            this.lrs,
            o,
            "DELETE",
      ...
      (t.prototype.sendAgentProfile = function (t, e, i, n, r, o) {
        if (this.testConfig()) {
          ...
          )).replace("<profileid>", encodeURIComponent(e));
          var a = null;
          n && r
            ? u("Can't have both If-Match and If-None-Match")
            : n
      ...
      (_.dateFromISOString = function (t) {
        var e = t.match(
          ...
          i = 0,
          n = new Date(e[1], 0, 1);
        e[3] && n.setMonth(e[3] - 1),
          e[5] && n.setDate(e[5]),
          e[7] && n.setHours(e[7]),
          e[8] && n.setMinutes(e[8]),
          e[10] && n.setSeconds(e[10]),
          e[12] && n.setMilliseconds(1e3 * Number("0." + e[12])),
          e[14] &&
            ((i = 60 * Number(e[16]) + Number(e[17])),
            (i *= "-" == e[15] ? 1 : -1)),
          (i -= n.getTimezoneOffset()),
          (time = Number(n) + 60 * i * 1e3);
        var r = new Date();
        return r.setTime(Number(time)), r;
      }),
      (_.XHR_request = function (t, n, r, e, i, o, s, a, c, p, l) {
        "use strict";
        var u,
          d,
          h,
          ...
          m = !1,
          S = !1,
          b = n.toLowerCase().match(/^(.+):\/\/([^:\/]*):?(\d+)?(\/.*)?$/),
          w = window.location,
          x = { "Content-Type": "application/json" };
        if (
          ((x.Authorization = i),
          (x["X-Experience-API-Version"] = _.XAPIWrapper.xapiVersion),
          null !== c)
        )
          for (var C in c) c.hasOwnProperty(C) && (x[C] = c[C]);
        if (
          ((m =
            (m =
              w.protocol.toLowerCase() !== b[1] ||
              w.hostname.toLowerCase() !== b[2]) ||
            (null === b[3] ? ("http" === b[1] ? "80" : "443") : b[3]) ===
              w.port),
          null !== t && void 0 !== t.extended)
        ) {
          for (g in ((f = new Array()), t.extended))
            f.push(g + "=" + encodeURIComponent(t.extended[g]));
          0 < f.length &&
            (n += (-1 < n.indexOf("?") ? "&" : "?") + f.join("&"));
        }
        var A,
          I,
          R =
          ...
          (S = !0),
            (d = (function (t, e, i, n) {
              var r = e,
                ...
                s = r.indexOf("?");
              if (
                (0 < s && (o.push(r.substr(s + 1)), (r = r.substr(0, s))),
                (r = r + "?method=" + t),
                null !== i)
              )
                for (var a in i)
                  i.hasOwnProperty(a) &&
                    o.push(a + "=" + encodeURIComponent(i[a]));
              return (
                null !== n && o.push("content=" + encodeURIComponent(n)),
                { method: "POST", url: r, headers: {}, data: o.join("&") }
              );
            })(r, n, x, e)),
            (u = new XDomainRequest()).open(d.method, d.url);
        else
          for (var C in (((u = new XMLHttpRequest()).withCredentials = p),
          u.open(r, n, null != o),
          x))
            u.setRequestHeader(C, x[C]);
        function T() {
          if (y) return h;
          y = !0;
          var t = a && 404 === u.status;
          if (
            !(void 0 === u.status || (200 <= u.status && u.status < 400) || t)
          ) {
            var e;
            try {
              e =
            ...
            return (
              _.XAPIWrapper.log(e),
              _.xhrRequestOnError(u, r, n, o, s, l),
              (h = u)
            );
          }
          if (!o) return (h = u);
          if (s) l ? o(null, u, s) : o(u, s);
          else {
            var i;
            try {
        ...
        if (
          ...
          if (S)
            for (
              v = 1e3 + new Date();
              new Date() < v && 4 !== u.readyState && !y;

            )
              (A = void 0),
                (A = new XMLHttpRequest()),
                (I = window.location + "?forcenocache=" + _.ruuid()),
                A.open("GET", I, !1),
                A.send(null);
          return T();
        }
      ...
      (_.xhrRequestOnError = function (e, t, i, n, r, o) {
        if (n && o) {
          ...
          if (
            ((s = a
              ? new Error("Request error: " + e.status)
              : 0 === a || null === a
              ? new Error("Request error: aborted")
              : new Error("Reqeust error: unknown")),
            r)
          )
            n(s, e, r);
          else {
  ...
  (function (s) {
    function r(t, e) {
      ...
      return (
        ...
        t[n] ||
          (/\[\]$/.test(n)
            ? ((n = n.slice(0, -2)), Array.isArray(t[n]) || (t[n] = []))
            : (t[n] = {})),
        e ? r(t[n], e) : t[n]
      );
    }
    function n(t, e, i, n) {
      if (t && t.actor && t.verb && t.object) {
        var r = t;
        for (var o in r)
          "actor" != o && "verb" != o && "object" != o && (this[o] = r[o]);
        (t = r.actor), (e = r.verb), (i = r.object);
      }
      t
        ? t instanceof a
          ? (this.actor = t)
          : "Agent" !== t.objectType && t.objectType
          ? "Group" === t.objectType && (this.actor = new c(t))
          : (this.actor = new a(t))
        : (this.actor = null),
        (this.verb = e ? (e instanceof p ? e : new p(e)) : null),
        i
          ? "Activity" !== i.objectType && i.objectType
            ? "Agent" === i.objectType
              ? (this.object = i instanceof a ? i : new a(i))
              : "Group" === i.objectType
              ? (this.object = i instanceof c ? i : new c(i))
              : "StatementRef" === i.objectType
              ? (this.object = i instanceof u ? i : new u(i))
              : "SubStatement" === i.objectType
              ? (this.object = i instanceof d ? i : new d(i))
              : (this.object = null)
            : (this.object = i instanceof l ? i : new l(i))
          : (this.object = null),
        n && (this.result = n),
    ...
    var a = function (t, e) {
      if (
        ...
        (this.name = e),
        t && (t.mbox || t.mbox_sha1sum || t.openid || t.account))
      )
        ...
        /^mailto:/.test(t)
          ...
          : /^http[s]?:/.test(t)
          ? (this.openid = t)
          : t && t.homePage && t.name && (this.account = t);
    };
    (a.prototype.toString = function () {
      ...
      (a.prototype.isValid = function () {
        return (
          ...
          ("Group" === this.objectType && this.member)
        );
      });
    ...
    c.prototype = new a();
    var p = function (t, e) {
      if (t && t.id) for (var i in t) this[i] = t[i];
      else
        (this.id = t),
          e &&
            ("string" == typeof e || e instanceof String
              ? (this.display = { "en-US": e })
              : (this.display = e));
    };
    (p.prototype.toString = function () {
      return this.display && (this.display["en-US"] || this.display.en)
        ? this.display["en-US"] || this.display.en
        : this.id;
    }),
      ...
      if (t && t.id) {
        ...
        (this.objectType = "Activity"),
          ...
          (e || i) &&
            ((this.definition = {}),
            "string" == typeof e || e instanceof String
              ? (this.definition.name = { "en-US": e })
              : e && (this.definition.name = e),
            "string" == typeof i || i instanceof String
              ? (this.definition.description = { "en-US": i })
              : i && (this.definition.description = i));
    };
    ...
    var u = function (t) {
      if (t && t.id) for (var e in t) this[e] = t[e];
      else (this.objectType = "StatementRef"), (this.id = t);
    };
  ...
  (function (t) {
    ...
    function n(t) {
      if (
        "SubStatement" === t.objectType &&
        "SubStatement" !== t.object.objectType &&
        !(t.id || t.stored || t.version || t.authority)
      )
        return (
          a.xapiutil.getActorId(t.actor) +
          ":" +
          a.xapiutil.getVerbDisplay(t.verb) +
          ":" +
          a.xapiutil.getObjectId(t.object)
        );
    }
    (a.xapiutil = {}),
      (a.xapiutil.getLang = function () {
        var t;
      ...
      (a.xapiutil.getLangVal = function (t) {
        if (t && 0 != Object.keys(t).length) {
          for (
            var e, i = a.xapiutil.getLang(), n = !1;
            t[i]
              ? ((e = t[i]), (n = !0))
              : i.indexOf("-") && (i = i.substring(0, i.lastIndexOf("-"))),
              !n && "" !== i;
      ...
      (a.xapiutil.getMoreStatements = function (n, r, o) {
        ...
        a.XAPIWrapper.getStatements(o, null, function t(e) {
          if (e && e.response) {
            ...
            i.statements &&
              ((s = s.concat(i.statements)),
              n-- <= 0
                ? r(s)
                : i.more && "" !== i.more
                ? a.XAPIWrapper.getStatements(o, i.more, t)
                : "" === i.more && r(s));
          }
        });
      }),
      ...
      (a.xapiutil.getActorIdString = function (t) {
        ...
        return (e =
          e ||
          (t.account
            ? t.account.homePage + ":" + t.account.name
            : t.member
            ? "Anon Group " + t.member
            : "unknown"));
      }),
      ...
      (a.xapiutil.getObjectId = function (t) {
        ...
        return "Agent" === e || "Group" === e
          ? a.xapiutil.getActorId(t)
          : void 0;
      }),
      ...
      (a.xapiutil.getObjectDisplay = function (t) {
        ...
        var e =
          (function (t) {
            if (t.definition && t.definition.name)
              return a.xapiutil.getLangVal(t.definition.name);
          })(t) ||
          t.name ||
          t.id;
        if (!e) {
          ...
          "Agent" === i || "Group" == i
            ? (e = a.xapiutil.getActorDisplay(t))
            : "SubStatement" == i && (e = n(t));
        }
        return e;
      });
  })(this),
  (function () {
    var l = (window.ADL = window.ADL || {});
    function u(t) {
      for (
    ...
    function d(t) {
      var e =
        ...
        "&xAPILaunchService=" +
        u("xAPILaunchService");
      u("encrypted") && (e += "&encrypted=true");
      for (var i = 0; i < t.length; i++) {
        var n = t[i],
          r = n.href,
          o = n.attributes.getNamedItem("courselink");
        o &&
          "true" == o.value &&
          ((r = -1 < r.indexOf("?") ? r + "&" + e : r + "?" + e), (n.href = r));
      }
    }
    l.launch = function o(s, a, c) {
      s = (function (n) {
        return function () {
          var i = arguments;
      ...
      try {
        var n = u("xAPILaunchKey"),
          r = u("xAPILaunchService");
        if (
          (u("encrypted"),
          (o.terminate = function (t) {
            var e = new URL(r);
            e.pathname += "launch/" + n + "/terminate";
            var i = new XMLHttpRequest();
            (i.withCredentials = !0),
              (i.crossDomain = !0),
              i.open("POST", e.toString(), !1),
          ...
          return s("invalid launch parameters");
        var t = new URL(r);
        t.pathname += "launch/" + n;
        ...
        (p.withCredentials = !0),
          ...
          (p.onload = function (t) {
            if (200 !== p.status) return p.onerror(p.responseText);
            var e = JSON.parse(p.responseText),
              i = e,
              n = {};
            (n.endpoint = i.endpoint),
              (n.actor = i.actor),
              (n.withCredentials = !0),
              (n.strictCallbacks = c || !1),
              (window.onunload = function () {
                a && o.terminate("User closed content");
              });
            var r = new l.XAPIWrapper.constructor();
            return (
              r.changeConfig(n),
              ...
              (function () {
                ...
                new MutationObserver(function (t) {
                  t.forEach(function (t) {
                    for (var e in t.addedNodes)
                      t.addedNodes.hasOwnProperty(e) &&
                        t.addedNodes[e].constructor == HTMLAnchorElement &&
                        d([t.addedNodes[e]]);
                  });
